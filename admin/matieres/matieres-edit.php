<?php
    ...
    if(isset($_POST['submit'])){
        if(!empty($_POST['nom']) && !empty($_POST['id'])){
            ...
            setcookie("success","La matière ".$nom." a été modifiée.",time()+(86400*30),"/");
    ...
    if(isset($_GET['id']) && !empty($_GET['id'])){
        ...
        $_POST['id'] = $old_value['id_matiere'];
        $_POST['nom'] = $old_value['nom_matiere'];
        $_POST['desc'] = $old_value['desc_matiere'];
    }
?>
<!Doctype html>
<html lang="fr">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-payment-inner-st">
                                <ul id="myTabedu1" class="tab-review-design">
                                    <li class="active">Modification de matière</li>
                                </ul>
