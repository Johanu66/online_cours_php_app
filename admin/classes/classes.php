...
<html lang="fr">
    ...
    <body>
                                    ...
                                    <div class="main-sparkline13-hd" style="display: flex; justify-content: space-between;margin-bottom: 40px;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="classes-add.php"><button class="btn btn-primary mr-2">Ajouter une nouvelle classe</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script>
            ...
            console.log($('#table'));
            var classesDataTable = $('#table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
                    url:"classes-fetch.php", //changer
                    type:"POST"
                },
                "columnDefs":[
                    {
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur la classe");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer cette classe ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
