    ...
    <body>
                                    ...
                                    <div class="main-sparkline13-hd" style="display: flex; justify-content: space-between;margin-bottom: 40px;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="matieres-add.php"><button class="btn btn-primary mr-2">Ajouter une nouvelle matière</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script>
            ...
            var matieresDataTable = $('#table').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"matieres-fetch.php", //changer
                    type:"POST"
                },
                "columnDefs":[
                    {
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur la matière");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                var id = $(this).attr('id');
                swal({
                    title: 'Suppression de matiére',
                    text: 'Etes-vous sûre de vouloir supprimer cette matiére ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
